...
(function() {
    ...
    menuContent.style.background = '#121212'; 
    ...
    menuContent.classList.add('custom-menu'); 
    ...
    accountList.classList.add('custom-list'); // 
    ...
    function createAccountActionMenu(username, listItem) {
        ...
        actionMenu.classList.add('custom-menu'); 
    ...
    function openEditSubMenu(username) {
        ...
        editUsernameInput.classList.add('custom-input'); 
        ...
        editPasswordInput.classList.add('custom-input'); 
    ...
    function createAccountAction(username) {
        ...
        usernameText.style.color = 'magenta'; 
        usernameText.style.cursor = 'pointer';
        usernameText.style.transition = 'color 0.7s'; 


        usernameText.addEventListener('mouseover', () => {
            usernameText.style.color = 'violet'; 
        });
