...
// @version      1.3
// @description  Helps you read your profile friendslist and requests way faster, no more struggle.
// @author       ⛧ sim
...
(function () {
    ...
    async function fetchAndAppendRequests() {
        ...
        try {
            ...
            console.log('Requests Data:', responseData); 
    ...
    function appendCustomUI() {
        ...
        customDiv.style.width = '540px';
        customDiv.style.height = '360px';
